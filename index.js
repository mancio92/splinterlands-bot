...
async function startBotPlayMatch(page, browser) {
  ...
  if (
    ...
    if (ecr < parseFloat(process.env.ECR_STOP_LIMIT)) {
      ...
      console.log(
        chalk.bold.red(`ECR Not yet Recovered to ${process.env.ECR_RECOVER_TO}`)
      );
    }
  ...
  if (process.env.CLAIM_SEASON_REWARD === "true") {
    try {
      ...
      await page
        .waitForSelector("#claim-btn", { visible: true, timeout: 3000 })
        .then(async (button) => {
          button.click();
          console.log(
  ...
  try {
    ...
    await page
      .waitForXPath("//button[contains(., 'BATTLE')]", { timeout: 20000 })
      .then((button) => {
    ...
    await page
      .waitForSelector(".btn--create-team", { timeout: 50000 })
        ...
        await page
          ...
          .catch(async () => {
            ...
            await page
              ...
              .then((button) => button.click())
              .catch((e) =>
                console.error("[ERROR] waiting for Battle button second time")
              );
            await page.waitForTimeout(5000);
            await page
              .waitForSelector(".btn--create-team", { timeout: 50000 })
  ...
  try {
    await page
      ...
      .catch(async () => {
        console.log(
          teamToPlay.summoner,
          "divId not found, reload and try again"
        );
        page.reload();
        await page.waitForTimeout(2000);
        page
          ...
          .then((summonerButton) => {
            summonerButton.click();
            console.log(teamToPlay.summoner, "clicked");
          })
          .catch(() => {
    ...
    await page.waitForTimeout(5000);
    await page
      .waitForSelector("#btnRumble", { timeout: 90000 })
      .then(() => console.log("btnRumble visible"))
      .catch(() => console.log("btnRumble not visible"));
    await page.waitForTimeout(5000);
    await page
